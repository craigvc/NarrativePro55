...
void EmptyLinkFunctionForGeneratedCodeNarrativeArsenal_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_NarrativeArsenal()
	{
		if (!Z_Registration_Info_UPackage__Script_NarrativeArsenal.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_NarrativeArsenal_OnRequestedNPCReady__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_NarrativeArsenal(Z_Construct_UPackage__Script_NarrativeArsenal, TEXT("/Script/NarrativeArsenal"), Z_Registration_Info_UPackage__Script_NarrativeArsenal, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x2777EAF0, 0xB730A5D8));
