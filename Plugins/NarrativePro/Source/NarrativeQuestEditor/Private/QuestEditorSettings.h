...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = "Quests", noclear, meta = (MetaClass = "/Script/NarrativeArsenal.Quest"))
	FSoftClassPath DefaultQuestClass;

	UPROPERTY(EditAnywhere, config, Category = "Quests", noclear, meta = (MetaClass = "/Script/NarrativeArsenal.QuestBranch"))
	FSoftClassPath DefaultQuestBranch;

	UPROPERTY(EditAnywhere, config, Category = "Quests", noclear, meta = (MetaClass = "/Script/NarrativeArsenal.QuestState"))
