...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = "Graph Defaults", noclear, meta = (MetaClass="/Script/NarrativeArsenal.DialogueNode_NPC"))
	FSoftClassPath DefaultNPCDialogueClass;

	UPROPERTY(EditAnywhere, config, Category = "Graph Defaults", noclear, meta = (MetaClass = "/Script/NarrativeArsenal.DialogueNode_Player"))
	FSoftClassPath DefaultPlayerDialogueClass;

	UPROPERTY(EditAnywhere, config, Category = "Graph Defaults", noclear, meta = (MetaClass = "/Script/NarrativeArsenal.Dialogue"))
