...
UDialogueEditorSettings::UDialogueEditorSettings()
{
	...
	auto DialogueNodeUserWidgetFinder = ConstructorHelpers::FClassFinder<UDialogueNodeUserWidget>(TEXT("/Script/UMGEditor.WidgetBlueprint'/NarrativePro/NarrativeTales/NarrativeUI/Widgets/Editor/WBP_DefaultDialogueNode.WBP_DefaultDialogueNode_C'"));
